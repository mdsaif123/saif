  ...
  return (
    <>
       {/* <Helmet>
        ...
        <meta name="description" content="Explore our top-notch services in web development, digital marketing, and more." />
        <meta name="keywords" content="services, web development, SEO, digital marketing, custom solutions" />
      </Helmet> */}
    ...
    <div className="service-container">
      <div className="container text-white my-5">
        ...
        <div className="row">
          <div className="col-md-4 my-3">
            <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(0, 229, 255, 0.2)">
              <div className="card text-center" data-aos="fade-up" data-aos-delay="150">
                <div className="card-body">
                  {/* Icon at the top center */}
                  <div>
                    <ApiIcon style={{ fontSize: "50px", color: "#00ff99" }} />
